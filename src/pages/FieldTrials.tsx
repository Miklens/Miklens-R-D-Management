...
export const FieldTrials: React.FC = () => {
  ...
  const [trialList, setTrialList] = useState(mockTrials);
  ...
  const handleCreateTrial = (e: React.FormEvent) => {
    ...
    setTrialList([newTrial, ...trialList]);
    setNameInput('');
    setLocationInput('');
    setShowModal(false);
  };
              ...
              <form onSubmit={handleCreateTrial} className="p-6 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input type="date" defaultValue={new Date().toISOString().split('T')[0]} className="w-full px-4 py-2.5 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl" />
                  </div>
                </div>
