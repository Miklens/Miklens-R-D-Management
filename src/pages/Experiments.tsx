  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Experiments & Testing Operations</h2>
          <p className="text-gray-500 dark:text-gray-400 text-sm">Unified lab testing, CIPAC stability tracking, field trials, and observations</p>
        </div>
