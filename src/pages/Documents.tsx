  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Documents Library</h2>
          <p className="text-gray-500 dark:text-gray-400 text-sm">Upload, organize, and download research files and lab reports</p>
        </div>
        <button
          ...
          >
            ...
            >
              ...
              <form onSubmit={handleUpload} className="p-6 space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">File Title / Name</label>
                  <input 
                    type="text" 
                    placeholder="e.g. BioShield Trial Report Q3.pdf" 
                    value={fileNameInput}
