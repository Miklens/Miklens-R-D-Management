...
export const Projects: React.FC = () => {
  ...
  const [productInput, setProductInput] = useState('BioShield Alpha');
              ...
              <form onSubmit={handleCreateProject} className="p-6 space-y-4">
                ...
                <div>
                  ...
                  <select 
                    ...
                    className="w-full px-4 py-2.5 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl"
                  >
                    <option value="BioShield Alpha">BioShield Alpha</option>
                    <option value="NemaKill Pro">NemaKill Pro</option>
                    <option value="RootBoost X">RootBoost X</option>
                    <option value="AeroSpore V2">AeroSpore V2</option>
                  </select>
                </div>
                <div>
