      ...
      <div className="flex items-center gap-2">
        ...
        <div className="hidden md:flex items-center">
          <button
            ...
            className="flex items-center gap-2 w-48 lg:w-64 pl-3 pr-4 py-2 bg-gray-50/80 dark:bg-gray-800/50 hover:bg-gray-100 dark:hover:bg-gray-800 border border-gray-200/50 dark:border-gray-700/50 rounded-xl text-sm text-gray-400 text-left transition-all cursor-pointer"
          >
            <Search className="w-4 h-4 text-gray-400 shrink-0" />
            <span className="flex-1 font-medium text-xs truncate">Search R&D DB...</span>
            <kbd className="hidden lg:inline-block px-1.5 py-0.5 text-[9px] font-mono font-bold bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-300 rounded">
              ⌘K
            </kbd>
          </button>
        </div>
