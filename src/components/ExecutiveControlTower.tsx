      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <div className="p-3.5 rounded-2xl bg-white/5 border border-white/10 space-y-1">
          ...
          <div className="flex items-baseline justify-between">
            <span className="text-2xl font-black text-white">2 Active</span>
            <Users className="w-4 h-4 text-emerald-400" />
          </div>
          <span className="text-[10px] text-emerald-400 font-bold">100% On-Duty Today</span>
        </div>
        ...
        <div className="p-3.5 rounded-2xl bg-white/5 border border-white/10 space-y-1">
          ...
          <span className="text-[10px] text-amber-400 font-bold">BioShield Alpha Testing</span>
        </div>
        ...
        <div className="p-3.5 rounded-2xl bg-white/5 border border-white/10 space-y-1">
          <span className="text-[10px] font-semibold text-gray-400 uppercase tracking-wider block">CIPAC Stability</span>
          <div className="flex items-baseline justify-between">
            <span className="text-2xl font-black text-purple-300">95.8%</span>
            <ShieldCheck className="w-4 h-4 text-purple-400" />
          </div>
          <span className="text-[10px] text-emerald-400 font-bold">Passed 54°C 14-Day Stress</span>
        </div>
      </div>
